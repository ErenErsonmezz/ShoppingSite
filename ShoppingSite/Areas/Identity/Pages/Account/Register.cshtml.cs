    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                Where(x => x.Name != ApplicationRole.Person)
                .Select(y => y.Name).Select(u => new SelectListItem
                {
                    Text = u,
                    Value = u
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(ApplicationRole.Person))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(ApplicationRole.Person));
                    }
